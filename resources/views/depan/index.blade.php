        ...
        <section class="resume-section" id="about">
            <div class="resume-section-content">
                ...
                <div class="subheading mb-5">
                    ...
                    <a href="">{{ get_meta_value('_email') }}</a>
                </div>
                {{-- <div class="subheading mb-5">
                    {{ get_meta_value('_kota') }} · {{ get_meta_value('_provinsi') }} · {{ get_meta_value('_nohp') }} ·
                ...
                <div class="social-icons">
                    ...
                    <a class="social-icon" href="https://github.com/maulanaa6?tab=repositories"><i class="fab fa-github"></i></a>
                    <a class="social-icon" href="https://www.instagram.com/maulanx_6/"><i class="fab fa-instagram"></i></a>
                    <a class="social-icon" href="https://web.facebook.com/maulana.ismail.1441"><i class="fab fa-facebook-f"></i></a>
